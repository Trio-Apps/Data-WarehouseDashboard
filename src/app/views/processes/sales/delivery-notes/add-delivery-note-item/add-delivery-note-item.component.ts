...
@Component({
  selector: 'app-add-delivery-note-item',
  imports: [
    CommonModule,
    ButtonModule,
    FormModule,
  ...
  templateUrl: './add-delivery-note-item.component.html',
  styleUrl: './add-delivery-note-item.component.scss',
})
export class AddDeliveryNoteItemComponent implements OnInit {
  ...
  onAddByBarcode(): void {
    ...
    this.deliveryNoteService.addDeliveryNoteItemByBarcode(this.deliveryNoteId, barcode).subscribe({
      next: () => {
        this.saving = false;
  ...
  onAddManually(): void {
    ...
    this.deliveryNoteService.addDeliveryNoteItemManually(this.deliveryNoteId, itemData).subscribe({
      next: () => {
        this.saving = false;
